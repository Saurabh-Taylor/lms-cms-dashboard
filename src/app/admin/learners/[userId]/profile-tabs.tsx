...
export function LearnerProfileTabs({
  ...
  userId: number;
  stats: { enrolledCount: number; avgProgress: number };
}) {
  return (
      ...
      <TabsContent value="overview" className="mt-4">
        <div className="grid grid-cols-2 gap-3 max-w-xl">
          <Card><CardContent className="pt-4">
            ...
            <p className="text-(length:--fs-meta) leading-4 text-muted-foreground">Enrolled courses</p>
          </CardContent></Card>
          <Card><CardContent className="pt-4">
            <div className="flex items-baseline gap-2">
              <p className="text-2xl font-semibold tabular-nums">{stats.avgProgress}%</p>
            </div>
            <p className="text-(length:--fs-meta) leading-4 text-muted-foreground">Average progress</p>
