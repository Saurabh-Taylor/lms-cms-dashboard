          ...
          <TableToolbar>
            ...
            {hasActiveFilters && (
              <button
                ...
                className="text-(length:--fs-meta) leading-4 text-muted-foreground underline-offset-2 transition-colors duration-(--duration-fast) hover:text-foreground hover:underline animate-in fade-in slide-in-from-left-1"
              >
                Clear filters
              </button>
            )}
